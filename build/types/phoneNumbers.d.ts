...
export declare class phoneNumbersClass extends BaseClass {
    requestCode(body: RequestCodeObject): Promise<RequesterResponseInterface<PhoneNumbersResponseObject>>;
    verifyCode(body: VerifyCodeObject): Promise<RequesterResponseInterface<PhoneNumbersResponseObject>>;
}
export {};
